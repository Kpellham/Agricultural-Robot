...
motordis = 0.075#I require the distance between the motors so im setting this value to zero for now
...
def turnZdeg(m1, m2, speed, deg):
    ...
    m2.run_to_rel_pos(position_sp=-1*fac*rot-20,speed_sp=-1*speed)
